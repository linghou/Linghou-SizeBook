...
public class PersonEditor {
    ...
    public PersonEditor(Context context){
        ...
        this.neck = new EditTextWithLabel(context, "Neck",true,"in inches");
        linearLayout.addView(this.neck.getLinearLayout());
        this.bust = new EditTextWithLabel(context, "Bust",true,"in inches");
        linearLayout.addView(this.bust.getLinearLayout());
        this.chest = new EditTextWithLabel(context, "Chest",true,"in inches");
        linearLayout.addView(this.chest.getLinearLayout());
        this.waist = new EditTextWithLabel(context, "Waist",true,"in inches");
        linearLayout.addView(this.waist.getLinearLayout());
        this.hip = new EditTextWithLabel(context, "Hip",true,"in inches");
        linearLayout.addView(this.hip.getLinearLayout());
        this.inseam = new EditTextWithLabel(context, "Inseam",true,"in inches");
